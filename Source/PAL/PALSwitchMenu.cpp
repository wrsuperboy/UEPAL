...
void UPALSwitchMenu::Enable()
{
	OnToggled.Broadcast(true);
}

void UPALSwitchMenu::Disable()
{
	OnToggled.Broadcast(false);
}

TSharedRef<SWidget> UPALSwitchMenu::RebuildWidget()
{
	if (!GetRootWidget())
	{
...
UWidget* UPALSwitchMenu::BuildBox(UWidget* Content)
{
...
void UPALSwitchMenu::NativeConstruct()
{
	...
	OnClickedYes.BindUFunction(this, "Enable");
	...
	YesButtonText->SetText(FText::FromString(Common->GetWord(18)));
